            ...
            <form className="space-y-4">
              <div className="flex gap-4">
                <input
                  ...
                  className="w-1/2 border rounded-lg px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all"
                />
                <input
                  type="text"
              ...
              />
              <select className="w-full border rounded-lg px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all">
              ...
              <button
                type="submit"
                className="w-full bg-black text-white rounded-lg py-3 text-base font-semibold hover:bg-gray-800 transition-colors"
              >
                Submit
              </button>
            </form>
