  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start bg-white mt-20 py-8">
     ...
     <div className="grid grid-cols-5 grid-rows-4 gap-2">
        ...
        <div className="relative col-span-3 row-span-2 col-start-3 rounded-[28px] bg-blue-100 overflow-hidden">
          <img src={droneImage} alt="Drone" className="w-full h-full object-cover rounded-[28px]" />
