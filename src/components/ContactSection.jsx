...
const ContactSection = () => {
  ...
  return (
    <div className="min-h-screen mt-[10rem] flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-200">
                          ...
                          <input
                            ...
                            className={`w-full pl-10 pr-3 py-2 rounded-lg border ${
                              errors.firstName
                                ? "border-red-400"
                                : "border-gray-200"
                            } bg-white focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-all text-sm md:text-base`}
