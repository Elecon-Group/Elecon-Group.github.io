...
import droneImage from "../assets/comingSoon_img/drone.jpg";
  ...
  return (
    <div className="max-w-6xl mx-auto py-12 px-4">
      ...
      <div className="grid grid-cols-5 grid-rows-4 gap-2">
        ...
        <div className="relative col-span-3 row-span-2 col-start-3 rounded-[28px] bg-blue-100 overflow-hidden flex items-center justify-center">
          ...
          <div className="absolute inset-0  bg-gradient-to-r from-black/80 to-transparent p-8 flex flex-col justify-center">
            ...
            <p className="text-white mt-4">
              Elecon Aerotech is redefining drone applications across India.
            </p>
          </div>
        </div>
        {/* Yellow Card - spans 3 columns, 2 rows, starts at row 3 */}
        <div className="col-span-3 h-[200px] row-span-2 row-start-3 rounded-[28px] overflow-hidden bg-yellow-400 flex items-center justify-center">
          <img src={yellowCard} alt="Stay Tuned" className="w-full h-full" />
        </div>
        {/* Features Card - spans 2 columns, 2 rows, starts at column 4, row 3 */}
        <div className="col-span-2 h-[200px] row-span-2 col-start-4 row-start-3 rounded-[28px] overflow-hidden bg-black flex items-center justify-center">
